          ...
          ?>
            <tr>
              ...
              <td>
                ...
                ?>
                  <a href="?page=peminjaman_ubah1&&id=<?php echo $data['id_peminjam']; ?>" class="btn btn-info">Ubah</a>
                  <a onclick="return confirm('Apakah anda yakin untuk menghapus data ini?');" href="?page=peminjaman_hapus&&id=<?php echo $data['id_peminjam']; ?>" class="btn btn-danger">Hapus</a>
                <?php
                }
                ?>
              </td>
