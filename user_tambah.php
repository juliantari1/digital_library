                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_POST['register'])) {
                                        ...
                                        if ($insert) {
                                            echo '<script>alert("selamat datang"); location.href="?pafe=user"; </script>';
                                        } else {
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-floating mb-1">
                                            <input class="form-control" id="no_telepon" name="no_telepon" type="text" placeholder="masukan No. Telepon" required />
                                            <label for="inputEmail" class="small mb-1">NO. Telepon</label>
                                        </div>
                                        <div class="form-grup">

                                            <label class="small mb-1">alamat</label>
                                            <textarea name="alamat" rows="5" class="form-control py-4" required></textarea>
                                        </div>
                                        <div class="form-floating mb-1">
                                        ...
                                        <div class="form-floating mb-1">
                                            ...
                                            <label for="inputLevel">Sebagai</label>
                                        </div>

                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button class="btn btn-primary" type="submit" name="register" value="register">register</button>
                                            <a class="btn btn-danger" href="?page=user">login</a>
                                        </div>
                                    </form>
                                </div>
